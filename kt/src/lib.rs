...
// FIXME: validate actual Gas usage
// https://docs.near.org/concepts/basics/transactions/gas#accurate-estimates-with-automated-tests
...
impl Contract {
    ...
    #[init]
    pub fn new(owner_id: AccountId, stable_ft_id: AccountId) -> Self {
    ...
    pub(crate) fn buy(&mut self, account_id: &AccountId, amount: Balance) {
    ...
    pub fn sell(&mut self, amount: U128) -> Promise {
        ...
        ext_ft_transfer::ext(self.stable_ft_id.clone())
...
mod tests {
    ...
    fn test_buy() {
        ...
        testing_env!(context
            ...
            .predecessor_account_id(accounts(2))
            .build());
        contract.buy(&accounts(1), AMOUNT);
